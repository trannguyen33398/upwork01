...
const data = [
  {
    ...
    items: [
      { label: "Use Case", icons: <DashboardIcon />, path: "/use-case" },
      {
  ...
  },
  {
    ...
    items: [
      { label: "Sprints", icons: <AllInclusiveIcon />, path: "/sprints" },
      { label: "Bundles", icons: <AllInboxIcon />, path: "/bundles" },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Processes", icons: <MemoryIcon />, path: "/processes" },
    ],
  },
];
